...
import { Briefcase, FileText, Rocket, LayoutDashboard, LogOut, User, ChevronDown, Search, Landmark, Speech } from 'lucide-react';
...
const navigation = [
  ...
  { name: 'Interview Prep', href: '/interview-prep', icon: Speech, color: 'text-red-400' },
];
